...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  initDataUser() async {
    ...
    _nameController.text = dataUser!.userName!;
    _sekolahController.text = dataUser.userAsalSekolah!;
    gender = dataUser.userGender!;
    // _selectedClass = dataUser.userStatus!;
    print(dataUser.jenjang!);
